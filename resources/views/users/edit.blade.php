...
<div class="container mt-5">
    ...
    <form action="{{ route('users.update', $user->id) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="tel" name="nomor_telepon" class="form-control" value="{{ old('nomor_telepon', $user->nomor_telepon) }}" inputmode="numeric" pattern="08[0-9]{8,11}" minlength="10" maxlength="13">
