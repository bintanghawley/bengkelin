    ...
    <div class="flex-1 flex items-center justify-center p-6 pt-4">
        ...
        <div class="p-10 flex flex-col justify-center border-t md:border-t-0 md:border-l border-zinc-200 dark:border-zinc-800">
            ...
            <form action="{{ route('login') }}" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="tel" name="nomor_telepon" value="{{ old('nomor_telepon') }}" required placeholder="08xxxxxxxxxx"
                           ...
                           class="w-full bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-200 dark:border-zinc-700 rounded-xl px-4 py-3 text-zinc-900 dark:text-white focus:ring-2 focus:ring-red-600 focus:border-transparent outline-none transition placeholder:text-zinc-400 dark:placeholder:text-zinc-650">
                </div>
                <div>
            ...
            <div class="mt-8 pt-8 border-t border-zinc-200 dark:border-zinc-800 space-y-4 text-center">
                ...
                <a href="#" class="inline-block text-[10px] text-zinc-500 dark:text-zinc-500 hover:text-red-500 dark:hover:text-red-400 uppercase tracking-widest transition">Forgot Password?</a>
            </div>
        </div>
    </div>
</div>
