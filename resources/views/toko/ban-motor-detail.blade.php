        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div class="lg:col-span-6">
                <div class="relative bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-[2.5rem] aspect-square flex items-center justify-center p-8 group shadow-sm">
                    @if($tire->gambar)
                        <img src="{{ asset('storage/' . $tire->gambar) }}" alt="{{ $tire->nama }}" class="max-h-full max-w-full object-contain">
                    @else
                        {{-- Empty Placeholder --}}
            ...
            <div class="lg:col-span-6 space-y-8">
                ...
                <p class="text-xs text-blue-600 dark:text-blue-400 font-bold">
                    Dapatkan Ban {{ strtoupper($tire->merek) }} termurah di Planet Ban Terdekat Dari Lokasimu
                </p>
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    ...
                    <button type="button" onclick="alert('Fitur keranjang akan segera hadir!')" class="flex-1 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3.5 px-8 rounded-full transition flex items-center justify-center gap-2 text-sm uppercase tracking-wider">
