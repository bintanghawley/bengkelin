...
<div class="flex min-h-screen font-sans">
        ...
        <nav class="flex-1 px-4 space-y-2 mt-6">
            <div class="w-full flex items-center gap-3 px-4 py-3 hover:text-red-800 focus:text-red-600 outline-none text-gray-800 dark:text-white rounded-xl font-bold transition">
                DASHBOARD   
            </div>
            <div class="w-full flex items-center gap-3 px-4 py-3 text-gray-500 dark:text-zinc-400 hover:text-red-800 focus:text-red-600 outline-none rounded-xl font-bold transition">
                DATA BOOKING
            </div>
        </nav>

        <div class="p-4 border-t border-gray-200 dark:border-zinc-800">
            <a href="{{ route('home') }}" class="block w-full text-center text-[10px] text-gray-500 dark:text-zinc-500 hover:text-gray-900 dark:hover:text-white uppercase tracking-widest border border-gray-300 dark:border-zinc-800 py-2 rounded-lg">Kembali ke Beranda</a>
        </div>
    </aside>
