...
class OilSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $oils = [
            ...
            [
                'nama' => 'FEDERAL MATIC ECO 30 10W30 800 ml',
                'harga' => 42000,
                'stok' => 40,
                'gambar' => null,
                'jenis_oli' => 'oli motor matic',
                ...
                'tipe_oli' => 'Oli Semi Sintetik',
                'merek' => 'Federal Oil',
                'fitur' => 'Active Moly meredam gesekan mesin, Memperpanjang umur mesin, Menghemat konsumsi bensin',
                'deskripsi' => 'Oli pelumas mesin motor matic dengan viskositas rendah untuk menjaga akselerasi tetap halus dan bertenaga namun irit bahan bakar.',
            ],
            [
                'nama' => 'PERTAMINA ENDURO 4T SPORT 10W40 1 L',
                'harga' => 78000,
                'stok' => 18,
                'gambar' => null,
                'jenis_oli' => 'oli motor sport',
                ...
                'tipe_oli' => 'Oli Ester',
                'merek' => 'Pertamina',
                'fitur' => 'Mencegah slip kopling basah, Kestabilan viskositas tinggi, Standar internasional JASO MA2',
                'deskripsi' => 'Enduro 4T Sport merupakan pelumas sintetik berkualitas tinggi yang diformulasikan khusus untuk motor sport kopling basah guna menghasilkan akselerasi optimal.',
            ],
            [
            ...
            [
                'nama' => 'FEDERAL SUPREME XX 20W50 800 ml',
                'harga' => 46000,
                'stok' => 15,
                'gambar' => null,
                'jenis_oli' => 'oli motor bebek',
                ...
                'tipe_oli' => 'Oli Semi Sintetik',
                'merek' => 'Federal Oil',
                'fitur' => 'Ketahanan panas tinggi, Menjaga kompresi mesin tetap padat, Melindungi transmisi manual',
                'deskripsi' => 'Sangat cocok untuk sepeda motor bebek kopling basah yang sering bekerja keras membawa beban berat.',
            ]
        ];
