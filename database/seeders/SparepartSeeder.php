...
class SparepartSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $spareparts = [
            ...
            [
                'nama' => 'Filter Udara Stainless Steel X-Smart Washable',
                'harga' => 150000,
                'stok' => 10,
                'gambar' => null,
                'jenis_sparepart' => 'filter udara motor',
                'merek' => 'X-Smart',
                'fitur' => 'Kasa baja stainless SUS304 anti karat, Dapat dicuci dan dipakai selamanya, Aliran udara konstan maksimal',
                'deskripsi' => 'Filter udara seumur hidup dari X-Smart. Anda cukup mencuci dan membersihkannya dengan sabun/air mengalir saat kotor tanpa perlu membeli filter baru.',
            ]
        ];
